...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    super(scope, name);
    const dataAlicloudThreatDetectionVulWhitelistsDefault =
      new alicloud.dataAlicloudThreatDetectionVulWhitelists.DataAlicloudThreatDetectionVulWhitelists(
        this,
        "default",
        {
          ids: ["example_id"],
    ...
    new cdktf.TerraformOutput(
      this,
      "alicloud_threat_detection_vul_whitelist_example_id",
      {
        value: cdktf.propertyAccess(
          dataAlicloudThreatDetectionVulWhitelistsDefault.whitelists,
          ["0", "id"]
        ),
      }
    );
