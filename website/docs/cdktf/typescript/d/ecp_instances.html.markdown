...
* `status` - (Optional, Computed) Instance status. Valid values: `pending`, `running`, `starting`, `stopped`, `stopping`
  .
* `nameRegex` - (Optional, ForceNew) A regex string to filter results by mobile phone name.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-bea47d162b9cf7a39408ec1de70f3982b340220d4139d2103adabce7c9f77a26 -->