...
* `customType` - (ForceNew,Optional) The type of policy. Value:-**common**: standard policy-**custom**: custom policy
* `ids` - (Optional, ForceNew, Computed) A list of Baseline Strategy IDs.
* `baselineStrategyNames` - (Optional, ForceNew) The name of the Baseline Strategy. You can specify at most 10 names.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-0612df1502842e874fdafd3b4b260951f4b3b3f8f4f16d834594bb3c058c7d78 -->