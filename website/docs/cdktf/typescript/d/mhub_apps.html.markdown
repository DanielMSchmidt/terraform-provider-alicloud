...
* `nameRegex` - (Optional, ForceNew) A regex string to filter results by App name.
* `osType` - (Optional, ForceNew) The os type. Valid values: `android` and `iOs`.
...
* `apps` - A list of Mhub Apps. Each element contains the following attributes:
	...
	* `bundleId` - iOS application ID. Required when creating an iOS app. **NOTE:** Either `bundleId` or `packageName` must be set.
	...
	* `packageName` - Android App package name.  **NOTE:** Either `bundleId` or `packageName` must be set.
	* `productId` - The ID of the Product.
	* `type` - The type of the App. Valid values: `android` and `iOs`. 

<!-- cache-key: cdktf-0.17.0-pre.15 input-79a2afaf7b8244fd179e19642149c83d00fb25b30f01265afc109c0ff368999f -->