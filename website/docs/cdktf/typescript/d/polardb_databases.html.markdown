...
The `alicloudPolardbDatabases` data source provides a collection of PolarDB cluster database available in Alibaba Cloud account.
...
* `nameRegex` - (Optional) A regex string to filter results by database name.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-c170e29118653cdc39090cfa111055fc7cf7915d4b61f2b3f98af2acf4507b75 -->