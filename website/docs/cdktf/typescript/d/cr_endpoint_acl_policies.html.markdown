...
* `moduleName` - (Optional, ForceNew) The module that needs to set the access policy. Valid values: `registry`.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-6f1e3a68df547d0ba442efbf0e6a926e8a3bde948b3dd40e94e07cef35058643 -->