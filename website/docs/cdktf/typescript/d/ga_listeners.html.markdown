...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    super(scope, name);
    const dataAlicloudGaListenersExample =
      new alicloud.dataAlicloudGaListeners.DataAlicloudGaListeners(
        this,
        "example",
        {
    ...
    new cdktf.TerraformOutput(this, "first_ga_listener_id", {
      value: cdktf.propertyAccess(dataAlicloudGaListenersExample.listeners, [
        "0",
        "id",
      ]),
    });
...
* `acceleratorId` - (Required, ForceNew) The accelerator id.
* `ids` - (Optional, ForceNew, Computed)  A list of Listener IDs.
* `nameRegex` - (Optional, ForceNew) A regex string to filter results by Listener name.
