...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    super(scope, name);
    const dataAlicloudDbInstanceClassInfosResources =
      new alicloud.dataAlicloudDbInstanceClassInfos.DataAlicloudDbInstanceClassInfos(
        this,
        "resources",
        {
          commodityCode: "bards",
    ...
    new cdktf.TerraformOutput(this, "first_db_instance_class", {
      value: cdktf.propertyAccess(
        dataAlicloudDbInstanceClassInfosResources.infos,
        ["0"]
      ),
    });
  }
...
* `commodityCode` - (Required, ForceNew) The commodity code of the instance. Valid values:
...
* `orderType` - (Required, ForceNew) FThe type of order that you want to query. Valid values:
...
* `dbInstanceId` - (Optional) The ID of the primary instance.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-17896a688ba5a64c72e822431c979ff35b4b3b41bdd3613546ef295950111aab -->