...
-> **NOTE:** This data source supports `cnShanghai`, `cnHangzhou` and `apSoutheast1` regions.
...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    super(scope, name);
    new alicloud.dataAlicloudEventBridgeService.DataAlicloudEventBridgeService(
      this,
      "open",
      {
        enable: "On",
