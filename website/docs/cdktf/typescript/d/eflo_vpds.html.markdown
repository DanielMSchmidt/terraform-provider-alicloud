...
* `vpdId` - (ForceNew,Optional) The id of the vpd.
* `vpdName` - (ForceNew,Optional) The Name of the VPD.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-b4c63b34008cbaba3e5b8ec9177856cc046f4fb21cb48ff09857e3115ca1318e -->