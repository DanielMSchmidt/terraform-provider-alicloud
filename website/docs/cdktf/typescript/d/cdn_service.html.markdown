...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    super(scope, name);
    new alicloud.dataAlicloudCdnService.DataAlicloudCdnService(this, "open", {
      enable: "On",
...
* `internetChargeType` - (Optional) The new billing method. Valid values: `payByTraffic` and `payByBandwidth`. Default value: `payByTraffic`.
...
* `changingChargeType` -  The billing method to be effective.
* `changingAffectTime` - 	The time when the change of the billing method starts to take effect. The time is displayed in GMT.

<!-- cache-key: cdktf-0.17.0-pre.15 input-28abd5b5a200676f53df8317c00f6b4337ebcadcffb200735b2d8926959a6f2c -->