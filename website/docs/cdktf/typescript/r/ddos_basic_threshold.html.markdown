...
* `instanceType` - (Required, ForceNew) The type of the Instance. Valid values: `ecs`,`slb`,`eip`.
* `internetIp` - (Required, ForceNew) The IP address of the public IP address asset.
...
```
<!-- cache-key: cdktf-0.17.0-pre.15 input-e592f3705cb2ec39fe83a8d9c3f8500fd1a9a3101aa881fcc9e504d55dc4a009 -->