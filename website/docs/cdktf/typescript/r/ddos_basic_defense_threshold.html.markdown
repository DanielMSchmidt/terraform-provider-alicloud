...
* `instanceType` - (Required, ForceNew) The instance type of the public IP address asset. Value: `ecs`,`slb`,`eip`.
* `instanceId` - (Required, ForceNew) The ID of the instance.
* `ddosType` - (Required, ForceNew) The type of the threshold to query. Valid values: `defense`,`blackhole`.
...
* `isAuto` - (Optional, Computed) Whether it is the system default threshold. Value:
...
* `internetIp` - (Optional) The Internet IP address.
...
```
<!-- cache-key: cdktf-0.17.0-pre.15 input-34827e4ac1710e047564653b153b5acdefbca78dad3cb96db4411f7d391bbaf4 -->