...
* `userId` - (Required, ForceNew) The ID of the user that you want to authorize to manage the specified hosts and host accounts.
* `hostId` - (Required, ForceNew) The ID of the host.
* `instanceId` - (Required, ForceNew) The ID of the Bastionhost instance where you want to authorize the user to manage the specified hosts and host accounts.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-146fe4eccd5b0fa6ecc3e13b9795504babc79dde783b83bc11e8d7656c302d9b -->