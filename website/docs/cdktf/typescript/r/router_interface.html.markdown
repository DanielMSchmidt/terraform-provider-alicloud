...
-> **DEPRECATED:**  This resource  has been deprecated from version `11990`. Please use new resource [alicloud_express_connect_router_interface](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/express_connect_router_interface).
...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    ...
    new alicloud.routerInterface.RouterInterface(this, "interface", {
      description: "test1",
      name: "test1",
...
* `oppositeRegion` - (Required, ForceNew) The Region of peer side.
* `routerType` - (Required, ForceNew) Router Type. Optional value: VRouter, VBR. Accepting side router interface type only be VRouter.
...
* `routerId` - (Required, ForceNew) The Router ID.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-7e58f5b6f39c79b99ae736d532b3a6b7823fd71683482abff31f3eec7c336a4a -->