...
* `dbInstanceEndpointId` - (Required, ForceNew) The Endpoint ID of the instance.
* `connectionStringPrefix` - (Required) The prefix of the public endpoint.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-5bee209666c2733f75881040c7cda1420c1864e79ca9bdc07c1eb307a5946786 -->