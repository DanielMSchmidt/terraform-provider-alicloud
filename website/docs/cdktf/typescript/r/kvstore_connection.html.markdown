...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    super(scope, name);
    new alicloud.kvstoreConnection.KvstoreConnection(this, "default", {
...
* `connectionStringPrefix` - (Required) The prefix of the public endpoint. The prefix can be 8 to 64 characters in length, and can contain lowercase letters and digits. It must start with a lowercase letter.
...
* `connectionString` - The public connection string of KVStore DBInstance.
