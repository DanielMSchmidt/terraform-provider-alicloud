...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    ...
    new alicloud.vpcIpv4CidrBlock.VpcIpv4CidrBlock(this, "example", {
...
* `secondaryCidrBlock` - (Required, ForceNew) The IPv4 CIDR block. Take note of the following requirements:
