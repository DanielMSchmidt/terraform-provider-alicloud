...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    super(scope, name);
    new alicloud.ramUser.RamUser(this, "user", {
      comments: "yoyoyo",
...
* `displayName` - (Optional) Name of the RAM user which for display. This name can have a string of 1 to 128 characters or Chinese characters, must contain only alphanumeric characters or Chinese characters or hyphens, such as "-",".", and must not end with a hyphen.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-e30e44fa074fad237da5de0640505b90649620e8008cf3234d735de2e12ac6a4 -->