...
* `transitRouterRouteTableName` - (Optional) The name of the transit router route table.
* `transitRouterRouteTableDescription` - (Optional) The description of the transit router route table.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-705558657ac09a34413738f95ee1aa7376c810e84ed46f3e5d322c597c51e812 -->