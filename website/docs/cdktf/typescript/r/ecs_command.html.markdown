...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    super(scope, name);
    new alicloud.ecsCommand.EcsCommand(this, "example", {
      commandContent: "bHMK",
...
* `commandContent` - (Required, ForceNew) The Base64-encoded content of the command.
* `description` - (Optional, ForceNew) The description of command.
* `enableParameter` - (Optional, ForceNew) Specifies whether to use custom parameters in the command to be created. Default to: false.                                                                                                                  
...
* `workingDir` - (Optional, ForceNew) The execution path of the command in the ECS instance.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-fa9ed838745a5fb8ff9facc4af057d8cd222528d254eacd1d452275a69d1890b -->