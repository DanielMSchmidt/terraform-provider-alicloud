...
* `preferredBackupPeriod` - (Required) ADB Cluster backup period. Valid values: [Monday, Tuesday, Wednesday, Thursday, Friday, Saturday, Sunday].
* `preferredBackupTime` - (Required) ADB Cluster backup time, in the format of HH:mmZ- HH:mmZ. Time setting interval is one hour. China time is 8 hours behind it.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-62daad9cadbe60ee6671223da287cdf79e74e6deb9dd6b8782ec2cbbdb07d588 -->