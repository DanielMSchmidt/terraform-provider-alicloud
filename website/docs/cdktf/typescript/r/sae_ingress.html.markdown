...
* `certId` - (Optional) Cert Id.
* `defaultRule` - (Optional) Default Rule.
* `description` - (Optional) Description.
* `listenerPort` - (Required) SLB listening port.
...
* `slbId` - (Required, ForceNew) SLB ID.

#### Block rules

The rules supports the following: 

* `appId` - (Required) Target application ID.
* `appName` - (Required) Target application name.
* `containerPort` - (Required) Application backend port.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-1418b5d670592d7173ead79a8dfb49648be58c0d61dafb4c9953f7f20f79acf1 -->