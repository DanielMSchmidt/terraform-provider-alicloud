...
* `certificateId` - (Required, ForceNew) The Certificate ID.
...
* `listenerId` - (Required, ForceNew) The ID of the listener. **NOTE:** Only HTTPS listeners support this parameter.
...
```
<!-- cache-key: cdktf-0.17.0-pre.15 input-32880b9d096015317db802972cdab6fcaeca2f1c5a505e55ebcbd84df7f552f6 -->