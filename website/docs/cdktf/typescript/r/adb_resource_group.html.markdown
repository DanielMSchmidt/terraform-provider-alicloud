...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    super(scope, name);
    new alicloud.adbResourceGroup.AdbResourceGroup(this, "default", {
...
* `dbClusterId` - (Required,ForceNew) DB cluster id.
* `groupName` - (Required,ForceNew) The name of the resource pool. The group name must be 2 to 30 characters in length, and can contain upper case letters, digits, and underscore(_).
* `groupType` - (ForceNew,Optional) Query type, value description:
  * **etl**: Batch query mode.
  * **interactive**: interactive Query mode.
  * **default_type**: the default query mode.
* `nodeNum` - (Optional) The number of nodes. The default number of nodes is 0. The number of nodes must be less than or equal to the number of nodes whose resource name is USER_DEFAULT.
...
```
<!-- cache-key: cdktf-0.17.0-pre.15 input-83bd2092413e9a6a83f2d02e513e67b7fac99c0acd71ccacc99f89ef7574390a -->