...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    super(scope, name);
    new alicloud.expressConnectPhysicalConnection.ExpressConnectPhysicalConnection(
      this,
      "domestic",
      {
        accessPointId: "ap-cn-hangzhou-yh-B",
        bandwidth: cdktf.Token.asString(100),
...
* `accessPointId` - (Required, ForceNew) The Physical Leased Line Access Point ID.
...
* `lineOperator` - (Required) Provides Access to the Physical Line Operator. Valid values:
  * CT: China Telecom
  * CU: China Unicom
  * CM: china Mobile
  * CO: Other Chinese
...
* `peerLocation` - (Optional) and an on-Premises Data Center Location.
* `physicalConnectionName` - (Optional) on Behalf of the Resource Name of the Resources-Attribute Field.
* `portType` - (Optional) The Physical Leased Line Access Port Type. Valid value:
...
**NOTE:** From in v1.185.0+, The `40GBaseLr` and `100GBaseLr` is valid. and Set these values based on the water levels of background ports. For details about the water levels, contact the business manager.

* `redundantPhysicalConnectionId` - (Optional) Redundant Physical Connection to Which the ID.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-7e106becf7dd8243afb7f810e3981fabdc0dedc5b79d3150e0a0e17ea05d977f -->