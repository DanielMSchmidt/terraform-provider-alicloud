...
* `resourceId` - (Required, ForceNew) The resource ID need shared.
* `resourceShareId` - (Required, ForceNew) The resource share ID of resource manager.
* `resourceType` - (Required, ForceNew) The resource type of should shared, valid value 
  - `vSwitch`. 
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-67da949db33734238e75075b6e60d10e28bfff432055c10dc667ca656849279c -->