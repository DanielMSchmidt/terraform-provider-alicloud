...
* `peerVbrId` - (Required, ForceNew) The ID of the other VBR in the VBR failover group.
* `vbrHaName` - (Optional, ForceNew) The name of the VBR failover group.
...
```
<!-- cache-key: cdktf-0.17.0-pre.15 input-3d530e98933411cc494a7944aedb1817674e8b4395d354d81b193e9b7430f765 -->