...
* `certificateName` - (Optional, ForceNew) Name of the Certificate. 
...
* `name` - (Deprecated from 1.129.0, Optional, ForceNew) It has been deprecated from version 1.129.0 and using `certificateName` instead.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-f501b30b14e874b0a2e360d29dc0dd1f3a60de90b66d47a212e5accd8920ce86 -->