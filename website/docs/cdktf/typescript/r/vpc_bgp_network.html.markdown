...
* `dstCidrBlock` - (Required, ForceNew) The CIDR block of the virtual private cloud (VPC) or vSwitch that you want to connect to a data center.
* `routerId` - (Required, ForceNew) The ID of the vRouter associated with the router interface.
...
```
<!-- cache-key: cdktf-0.17.0-pre.15 input-e3299a80420cd2d5f58347e3823f014df57dc8ef310f0fbab33b3a5a57bf6421 -->