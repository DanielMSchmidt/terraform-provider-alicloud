...
* `diskId` - (Required, ForceNew) The source disk ID.
...
* `resourceGroupId` - (Optional, ForceNew, Available in 1.94.0+) The ID of the resource group.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-e3fff1ee0b282338f9410e9d0bd47de7e4bcaa49090dbe05db6a58dfb223736e -->