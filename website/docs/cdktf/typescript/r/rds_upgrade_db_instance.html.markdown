...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    ...
    const dataAlicloudRdsCrossRegionsExample =
    ...
    /*This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.*/
    dataAlicloudRdsCrossRegionsExample.overrideLogicalId("example");
    ...
    const alicloudRdsUpgradeDbInstanceExample =
      new alicloud.rdsUpgradeDbInstance.RdsUpgradeDbInstance(
        this,
        "example_6",
        {
          collectStatMode: "After",
          dbInstanceClass: cdktf.Token.asString(
            alicloudDbInstanceExample.instanceType
          ),
          dbInstanceDescription: "terraform-example",
          dbInstanceStorage: cdktf.Token.asNumber(
            alicloudDbInstanceExample.instanceStorage
          ),
          dbInstanceStorageType: cdktf.Token.asString(
            alicloudDbInstanceExample.dbInstanceStorageType
          ),
          instanceNetworkType: "VPC",
          paymentType: "PayAsYouGo",
          sourceDbInstanceId: cdktf.Token.asString(
            alicloudDbInstanceExample.id
          ),
          switchOver: "false",
    ...
    /*This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.*/
    alicloudRdsUpgradeDbInstanceExample.overrideLogicalId("example");
  }
}
...
* `paymentType` - (Required) The billing method of the new instance. Valid values: `payAsYouGo` and `subscription`.
* `dbInstanceClass` - (Required) The instance type of the new instance. For information, see [Primary ApsaraDB RDS instance types](https://www.alibabacloud.com/doc-detail/26312.htm).
* `dbInstanceStorage` - (Required) The storage capacity of the new instance. Unit: GB. The storage capacity increases in increments of 5 GB. For more information, see [Primary ApsaraDB RDS instance types](https://www.alibabacloud.com/doc-detail/26312.htm).
...
* `dbInstanceDescription` - (Optional, Computed) The db instance description.
...
* `engineVersion` - (Optional, Computed, ForceNew) Database version. Value:
  ...
  * MariaDB: **10.3**.
* `instanceNetworkType` - (Required, ForceNew) The network type of the instance. Valid values:
...
* `tdeStatus` - (Optional) Specifies whether to enable TDE. Valid values: `enabled` and `disabled`.
...
* `switchTimeMode` - (Optional) The time at which ApsaraDB RDS switches your workloads over to the new instance. This parameter is used together with the SwitchOver parameter and takes effect only when you set the SwitchOver parameter to true. Valid values:
...
* `switchOver` - (Required) Specifies whether ApsaraDB RDS automatically switches your workloads over to the new instance after data is migrated to the new instance. Valid values:
...
* `collectStatMode` - (Required) The time at which ApsaraDB RDS collects the statistics of the new instance.
...
* `targetMajorVersion` - (Required, ForceNew) The major engine version of the new instance. The value of this parameter must be the major engine version on which an upgrade check is performed.
...
```
<!-- cache-key: cdktf-0.17.0-pre.15 input-4927b403594fe8ad5db6f0410ada5b72ad10a630c94f8870bc4e393fb5a71b4f -->