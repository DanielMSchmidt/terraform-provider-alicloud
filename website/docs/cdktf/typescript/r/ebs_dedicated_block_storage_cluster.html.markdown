...
* `dedicatedBlockStorageClusterName` - (Required) The name of the resource
* `description` - (Computed,Optional) The description of the dedicated block storage cluster.
* `totalCapacity` - (Required,ForceNew) The total capacity of the dedicated block storage cluster. Unit: GiB.
...
```
<!-- cache-key: cdktf-0.17.0-pre.15 input-c0f7817ab0f0a6ce6d054e18ae5f1bdeca8a3c0b9a9bf857073d16d6abc7a8f7 -->