...
* `clusterId` - (Required, ForceNew) The ID of the cluster that you want to create the application.
* `instanceIds` - (Required, ForceNew) The ID of instance. Type: list.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-70274e6160bfdcafde1bb58daa2e86bf6260690605998bb3af829d4cb9777488 -->