...
* `backupPrefix` - (Optional) The backup prefix.
* `backupType` - (Required, ForceNew) The backup type. Valid values:
  - `complete`: full backup.
  - `incremental`: incremental backup.
  - `differential`: differential backup.
* `clusterId` - (Required, ForceNew) The ID of the SAP HANA instance.
* `databaseName` - (Required, ForceNew) The name of the database.
* `planName` - (Required) The name of the backup plan.
* `resourceGroupId` - (Optional) The resource attribute field that represents the resource group ID.
...
```
<!-- cache-key: cdktf-0.17.0-pre.15 input-d99a4d9cb7072ce193b0a5b2cde274016c3c587babef7027ce4488a076cfccd8 -->