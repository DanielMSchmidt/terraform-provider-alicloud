...
* `serverUrl` - (Required) The serverUrl of the Webhook. This url must start with `https://oapiDingtalkCom/robot/send?accessToken=`.
* `webhookName` - (Required) The name of the Webhook. **Note:** The name must be `2` to `12` characters in length, and can contain uppercase and lowercase letters.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-624a36a4127fc41de83bdba7296408796da6a30eb2f82fdbffc8c97832e1e73f -->