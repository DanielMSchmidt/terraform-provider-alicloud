...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    ...
    new alicloud.fnfFlow.FnfFlow(this, "example", {
      definition:
        "  version: v1beta1\n  type: flow\n  steps:\n    - type: pass\n      name: helloworld\n",
...
* `roleArn` - (Optional) The ARN of the specified RAM role that Serverless Workflow uses to assume the role when Serverless Workflow executes a flow.
