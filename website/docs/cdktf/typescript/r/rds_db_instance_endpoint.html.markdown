...
* `vpcId` - (Required) The virtual private cloud (VPC) ID of the internal endpoint.
* `vswitchId` - (Required) The vSwitch ID of the internal endpoint.
* `connectionStringPrefix` - (Required) The IP address of the internal endpoint.
...
* `dbInstanceEndpointDescription` - (Optional) The user-defined description of the endpoint.
* `nodeItems` - (Required) The information about the node that is configured for the endpoint.  It contains two sub-fields(node_id and weight). 
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-b83a289346b655a7d469b56d5d72d6326fadd9803b58a1895d12801a7a9a277a -->