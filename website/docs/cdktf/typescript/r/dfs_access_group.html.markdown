...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    super(scope, name);
    new alicloud.dfsAccessGroup.DfsAccessGroup(this, "example", {
...
* `accessGroupName` - (Required) The Name of Access Group.The length of `accessGroupName` does not exceed 100 bytes.
* `description` - (Optional) The Description of Access Group. The length of `description` does not exceed 100 bytes.
* `networkType` - (Required, ForceNew) The NetworkType of Access Group. Valid values: `vpc`.
