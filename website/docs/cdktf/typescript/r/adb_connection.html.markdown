...
* `connectionPrefix` - (ForceNew) Prefix of the cluster public endpoint. The prefix must be 6 to 30 characters in length, and can contain lowercase letters, digits, and hyphens (-), must start with a letter and end with a digit or letter. Default to `<db_cluster_id> + tf`.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-4bdeaf57da5f9b78313128ad8c7457d29a91c649e82b872cd19758067972de3a -->