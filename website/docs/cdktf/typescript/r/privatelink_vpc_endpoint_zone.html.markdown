...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    super(scope, name);
    new alicloud.privatelinkVpcEndpointZone.PrivatelinkVpcEndpointZone(
      this,
      "example",
      {
...
* `zoneId` - (Optional, Computed, ForceNew) The Zone Id.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-79488e637699926c90d8840319740a4d0f41a9a4ddb9ae0a59097421e56567b4 -->