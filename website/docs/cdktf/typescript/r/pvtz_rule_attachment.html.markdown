...
* `ruleId` - (Required, ForceNew) The ID of the rule.
...
* `vpcId` - (Required) The ID of the VPC.  **NOTE:** The VPC that can be associated with the forwarding rule must belong to the same region as the Endpoint.
* `regionId` - (Required) The region of the vpc. If not set, the current region will instead of.

## Attributes Reference

The following attributes are exported:

* `id` - The resource ID in terraform of Rule Attachment. Its value is same as `ruleId`.
...
```
<!-- cache-key: cdktf-0.17.0-pre.15 input-00d67a8f419a6986313582c4fa9b29980d697a71792ac3c9d8a72f654e816993 -->