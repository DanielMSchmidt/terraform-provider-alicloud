...
* `accelerateIpId` - (Required, ForceNew) The ID of the Basic Accelerate IP.
* `endpointId` - (Required, ForceNew) The ID of the Basic Endpoint.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-e06cdf61f9dea679b48a6d7a7c6b4835c0a6f1ac55ea01ee999fcfffd74275d6 -->