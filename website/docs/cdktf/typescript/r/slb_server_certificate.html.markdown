...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    super(scope, name);
    new alicloud.slbServerCertificate.SlbServerCertificate(this, "foo", {
...
* `alicloudCertificateId` - (Optional, ForceNew) an id of server certificate ssued/proxied by alibaba cloud. but it is not supported on the international site of alibaba cloud now.
...
* `alicloudCertificateRegionId` - (Optional, ForceNew, Available in 1.69.0+) the region of the certificate specified by `alicloudCertificateId`. but it is not supported on the international site of alibaba cloud now.
* `resourceGroupId` - (Optional, ForceNew, Available in 1.58.0+) The Id of resource group which the slb server certificate belongs.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-3ae4f00193195bcdb7ba329518720c1042e5ffb72b5c84a308405492b0477edf -->