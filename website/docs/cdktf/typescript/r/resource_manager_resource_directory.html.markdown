...
* `memberDeletionStatus` - (Optional, Available in v1.201.0+) Specifies whether to enable the member deletion feature. Valid values:`enabled` and `disabled`. 
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-d026d8b53448b33a563622f2efbf15a0c24699d431056f284eb3bf57970ce163 -->