...
* `userGroupId` - (Required, ForceNew) The ID of the user group that you want to authorize to manage the specified hosts and host accounts.
* `hostId` - (Required, ForceNew) The ID of the host.
* `instanceId` - (Required, ForceNew) The ID of the Bastionhost instance where you want to authorize the user group to manage the specified hosts and host accounts.
* `hostAccountIds` - (Required, List) A list IDs of the host account.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-92c16a7d4387e5a07e7c9c27f87b7d468a717e500cac8c14115700a062d118fe -->