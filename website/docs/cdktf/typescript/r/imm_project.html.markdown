...
* `serviceRole` - (Optional) The service role authorized to the Intelligent Media Management service to access other cloud resources. Default value: `aliyunImmDefaultRole`. You can also create authorization  roles through the `alicloudRamRole`.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-c11c349868563bf53466f5d85e7ba4d7402f93908aec5e6dd35de122cd64ed46 -->