...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    super(scope, name);
    new alicloud.sddpConfig.SddpConfig(this, "default", {
...
* `code` - (Optional, ForceNew) Abnormal Alarm General Configuration Module by Using the Encoding. Valid values: `accessFailedCnt`, `accessPermissionExprieMaxDays`, `logDatasizeAvgDays`.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-459eea038d9476950d312710585874e2dd4e1320a33c838aed1b07444263f962 -->