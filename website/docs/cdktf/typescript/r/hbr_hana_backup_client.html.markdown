...
* `clientInfo` - (Optional) The installation information of the HBR clients.
* `alertSetting` - (Optional, ForceNew, Computed) The alert settings. Valid value: `inherited`.
* `useHttps` - (Optional, ForceNew) Specifies whether to transmit data over HTTPS. Valid values: `true`, `false`.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-7046771ba3e364f53a8e92cbd3ba4f78dda67eaada474d8a48a0c77d77792bab -->