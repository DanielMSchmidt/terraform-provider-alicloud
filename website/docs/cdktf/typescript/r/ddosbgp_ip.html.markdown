...
* `status` - The current state of the IP address. Valid Value: `normal`, `holeBegin`.
...
```
<!-- cache-key: cdktf-0.17.0-pre.15 input-1dc1f8e7ca782e21a39d8b1d42f27962194424fc9afaa7a263722a08fcdef4e1 -->