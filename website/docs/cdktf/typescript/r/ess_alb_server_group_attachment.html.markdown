...
-> **NOTE:** Resource `alicloudEssAlbServerGroupAttachment` don't support modification.

-> **NOTE:** Resource `alicloudEssAlbServerGroupAttachment` is available in 1.158.0+.
...
* `scalingGroupId` - (Required, ForceNew) ID of the scaling group.
* `albServerGroupId` - (Required, ForceNew) ID of Alb Server Group.
...
* `forceAttach` - (Optional) If instances of scaling group are attached/removed from slb backend server when attach/detach alb
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-01d40d35427b1c808827d6e35e6fa95b54a9298667e0e1243bb52df986e5b8a8 -->