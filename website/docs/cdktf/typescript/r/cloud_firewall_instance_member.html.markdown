...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    ...
    const alicloudResourceManagerAccountDefault =
    ...
    const alicloudCloudFirewallInstanceMemberDefault =
      new alicloud.cloudFirewallInstanceMember.CloudFirewallInstanceMember(
        this,
        "default_2",
        {
          memberDesc: name.stringValue,
          memberUid: cdktf.Token.asString(
            alicloudResourceManagerAccountDefault.id
          ),
        }
      );
    /*This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.*/
    alicloudCloudFirewallInstanceMemberDefault.overrideLogicalId("default");
  }
}
...
* `memberDesc` - (Optional) Remarks of cloud firewall member accounts.
* `memberUid` - (Required,ForceNew) The UID of the cloud firewall member account.
...
* `id` - The `key` of the resource supplied above. Its value same as `memberUid`.
