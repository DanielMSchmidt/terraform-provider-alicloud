...
* `contactName` - (Required) The User's Contact Name. **Note:** The name must be 2 to 12 characters in length.
...
-> **NOTE:** When the user creates a contact, the user should use `alicloudMscSubContactVerificationMessage` to receive the verification message and confirm it.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-3479fe959643bf57b5a6f0be79bee05a87a99367e451591d3ef25302f52c9d9a -->