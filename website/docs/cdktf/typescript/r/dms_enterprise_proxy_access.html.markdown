...
* `indepAccount` - (ForceNew,Optional) Database account.
* `indepPassword` - (ForceNew,Optional) Database password.
...
```
<!-- cache-key: cdktf-0.17.0-pre.15 input-d154a8b9e5c4639be8c6d6feab0ea223f9cb1ba588a0b4f09069d5a6b3d79eb1 -->