...
* `commandContent` - (Required, ForceNew) The Contents of the Script to Base64 Encoded Transmission.
* `commandType` - (Required, ForceNew) The Script Type. Valid values: `runBatScript`, `runPowerShellScript`.
* `contentEncoding` - (Optional, Computed) That Returns the Data Encoding Method. Valid values: `base64`, `plainText`.
* `desktopId` - (Required, ForceNew) The desktop id of the Desktop.
...
```
<!-- cache-key: cdktf-0.17.0-pre.15 input-43c5ed40671cf8ae3d8c30349b8500edf90876818e2a5e61e16112930efe2b70 -->