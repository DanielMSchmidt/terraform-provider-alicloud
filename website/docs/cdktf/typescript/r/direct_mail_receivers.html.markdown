...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    super(scope, name);
    new alicloud.directMailReceivers.DirectMailReceivers(this, "example", {
...
* `receiversAlias` - (Required, ForceNew) The alias of receivers. Must email address and less than 30 characters in length.
* `receiversName` - (Required, ForceNew) The name of the resource. The length that cannot be repeated is 1-30 characters.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-bd51a53d4c74907832fac66f136febcd37f9000e615ad7e1b1cf6fb24e23c819 -->