...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        alicloud.elasticsearch_instance.ElasticsearchInstance(self, "instance",
            client_node_amount=cdktf.Token.as_number("2"),
            client_node_spec="elasticsearch.sn2ne.large",
            data_node_amount=cdktf.Token.as_number("2"),
            data_node_disk_size=cdktf.Token.as_number("20"),
            ...
            zone_count=cdktf.Token.as_number("2")
        )
```
## Argument Reference
