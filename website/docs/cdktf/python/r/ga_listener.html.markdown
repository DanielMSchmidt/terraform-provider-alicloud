...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        alicloud.ga_bandwidth_package_attachment.GaBandwidthPackageAttachment(self, "de_2",
        ...
        alicloud_ga_listener_example = alicloud.ga_listener.GaListener(self, "example_3",
            accelerator_id=cdktf.Token.as_string(alicloud_ga_accelerator_example.id),
