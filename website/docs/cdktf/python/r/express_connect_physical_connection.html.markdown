...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        alicloud.express_connect_physical_connection.ExpressConnectPhysicalConnection(self, "domestic",
            access_point_id="ap-cn-hangzhou-yh-B",
            bandwidth=cdktf.Token.as_string(100),
        ...
        alicloud.express_connect_physical_connection.ExpressConnectPhysicalConnection(self, "international",
