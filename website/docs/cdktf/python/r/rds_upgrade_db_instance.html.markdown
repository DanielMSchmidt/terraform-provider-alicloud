...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_rds_cross_regions_example =
        alicloud.data_alicloud_rds_cross_regions.DataAlicloudRdsCrossRegions(self, "example_2")
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        data_alicloud_rds_cross_regions_example.override_logical_id("example")
        ...
        alicloud_rds_upgrade_db_instance_example =
        alicloud.rds_upgrade_db_instance.RdsUpgradeDbInstance(self, "example_6",
            collect_stat_mode="After",
            db_instance_class=cdktf.Token.as_string(alicloud_db_instance_example.instance_type),
            db_instance_description="terraform-example",
            db_instance_storage=cdktf.Token.as_number(alicloud_db_instance_example.instance_storage),
            db_instance_storage_type=cdktf.Token.as_string(alicloud_db_instance_example.db_instance_storage_type),
        ...
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        alicloud_rds_upgrade_db_instance_example.override_logical_id("example")
```
