    ...
    def __init__(self, scope, name):
        ...
        alicloud_db_instance_example = alicloud.db_instance.DbInstance(self, "example_5",
            ...
            instance_type=cdktf.Token.as_string(
                cdktf.property_access(data_alicloud_db_instance_classes_example.instance_classes, ["0", "instance_class"])),
            monitoring_period=cdktf.Token.as_number("60"),
            parameters=[DbInstanceParameters(
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        alicloud_vswitch_example_count = cdktf.TerraformCount.of(
            cdktf.Token.as_number("2"))
        alicloud_vswitch_example = alicloud.vswitch.Vswitch(self, "example_3",
            cidr_block=cdktf.Token.as_string(
                cdktf.Fn.format("172.16.%d.0/24", [
                    cdktf.Op.add(alicloud_vswitch_example_count.index, 1)
                ])),
            vpc_id=cdktf.Token.as_string(alicloud_vpc_example.id),
            vswitch_name=cdktf.Token.as_string(
                cdktf.Fn.format("terraform_example_%d", [
                    cdktf.Op.add(alicloud_vswitch_example_count.index, 1)
                ])),
            zone_id=cdktf.Token.as_string(
                cdktf.property_access(
                    cdktf.property_access(data_alicloud_db_zones_example.zones, [alicloud_vswitch_example_count.index
                    ]), ["id"])),
            count=alicloud_vswitch_example_count
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        alicloud_vswitch_example.override_logical_id("example")
        data_alicloud_db_instance_classes_example =
        ...
        alicloud_db_instance_example = alicloud.db_instance.DbInstance(self, "example_5",
            ...
            vswitch_id=cdktf.Fn.join(",",
                cdktf.Token.as_list(
                    cdktf.property_access(alicloud_vswitch_example, ["*", "id"]))),
            zone_id=cdktf.Token.as_string(
                cdktf.property_access(data_alicloud_db_zones_example.zones, ["0", "id"])),
            zone_id_slave_a=cdktf.Token.as_string(
                cdktf.property_access(data_alicloud_db_zones_example.zones, ["1", "id"]))
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        alicloud_db_instance_example.override_logical_id("example")
```
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        alicloud_vswitch_example_count = cdktf.TerraformCount.of(
            cdktf.Fn.length_of(
                cdktf.property_access(data_alicloud_zones_example.zones, ["0", "multi_zone_ids"
                ])))
        alicloud_vswitch_example = alicloud.vswitch.Vswitch(self, "example_3",
            cidr_block=cdktf.Token.as_string(
                cdktf.Fn.format("172.16.%d.0/24", [
            ...
            vpc_id=cdktf.Token.as_string(alicloud_vpc_example.id),
            vswitch_name=cdktf.Token.as_string(
                cdktf.Fn.format("vswitch_%d", [alicloud_vswitch_example_count.index])),
            zone_id=cdktf.Token.as_string(
                cdktf.property_access(
                    cdktf.property_access(data_alicloud_zones_example.zones, ["0", "multi_zone_ids"
                    ]), [alicloud_vswitch_example_count.index])),
            count=alicloud_vswitch_example_count
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        alicloud_vswitch_example.override_logical_id("example")
        alicloud.db_instance.DbInstance(self, "this",
            engine="MySQL",
            engine_version="5.6",
            instance_charge_type="Postpaid",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        alicloud_vswitch_example = alicloud.vswitch.Vswitch(self, "example_3",
            ...
            vpc_id=cdktf.Token.as_string(alicloud_vpc_example.id),
            vswitch_name=cdktf.Token.as_string(
                cdktf.Fn.format("vswich_%d", [name.value, alicloud_vswitch_example_count.index
                ])),
            zone_id=cdktf.Token.as_string(
                cdktf.property_access(
                    cdktf.property_access(data_alicloud_zones_example.zones, [alicloud_vswitch_example_count.index
                    ]), ["id"])),
            count=alicloud_vswitch_example_count
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        alicloud_vswitch_example.override_logical_id("example")
        alicloud_db_instance_example = alicloud.db_instance.DbInstance(self, "example_4",
            engine="MySQL",
            engine_version="8.0",
            instance_charge_type="Postpaid",
            instance_name=name.string_value,
            ...
            zone_id=cdktf.Token.as_string(
                cdktf.property_access(data_alicloud_zones_example.zones, ["0", "id"])),
            zone_id_slave_a=cdktf.Token.as_string(
                cdktf.property_access(data_alicloud_zones_example.zones, ["1", "id"])),
            zone_id_slave_b=cdktf.Token.as_string(
                cdktf.property_access(data_alicloud_zones_example.zones, ["2", "id"]))
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        alicloud_db_instance_example.override_logical_id("example")
```
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_db_zones_example =
        alicloud.data_alicloud_db_zones.DataAlicloudDbZones(self, "example_2",
        ...
        alicloud_vswitch_example = alicloud.vswitch.Vswitch(self, "example_3",
            ...
            zone_id=cdktf.Token.as_string(
                cdktf.property_access(data_alicloud_db_zones_example.ids, ["1"]))
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        alicloud_vswitch_example.override_logical_id("example")
        data_alicloud_db_instance_classes_example =
        ...
        alicloud_db_instance_example = alicloud.db_instance.DbInstance(self, "example_5",
            ...
            instance_type=cdktf.Token.as_string(
                cdktf.property_access(data_alicloud_db_instance_classes_example.instance_classes, ["0", "instance_class"])),
            serverless_config=DbInstanceServerlessConfig(
                auto_pause=False,
                max_capacity=8,
                min_capacity=0.5,
                switch_force=False
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        alicloud_db_instance_example = alicloud.db_instance.DbInstance(self, "example_5",
            ...
            vswitch_id=cdktf.Fn.join(",",
                cdktf.Token.as_list([alicloud_vswitch_example.id, alicloud_vswitch_example.id
                ])),
            zone_id=cdktf.Token.as_string(
                cdktf.property_access(data_alicloud_db_zones_example.ids, ["1"])),
            zone_id_slave_a=cdktf.Token.as_string(
