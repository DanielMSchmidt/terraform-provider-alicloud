...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        alicloud.adb_db_cluster.AdbDbCluster(self, "this",
            db_cluster_category="Cluster",
            db_cluster_version="3.0",
            db_node_class="C8",
            db_node_count=cdktf.Token.as_number("4"),
            db_node_storage=cdktf.Token.as_number("400"),
...
* `db_cluster_class` - (Deprecated from v1.121.2+) It duplicates with attribute db_node_class and is deprecated from 1.121.2.
