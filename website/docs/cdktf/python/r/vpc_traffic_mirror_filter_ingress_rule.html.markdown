...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        alicloud_vpc_traffic_mirror_filter_ingress_rule_example =
        alicloud.vpc_traffic_mirror_filter_ingress_rule.VpcTrafficMirrorFilterIngressRule(self, "example_1",
        ...
        alicloud_vpc_traffic_mirror_filter_ingress_rule_example.override_logical_id("example")
```
