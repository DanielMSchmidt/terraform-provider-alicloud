...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        alicloud_dts_synchronization_instance_default =
        alicloud.dts_synchronization_instance.DtsSynchronizationInstance(self, "default",
        ...
        alicloud_dts_synchronization_job_default =
        alicloud.dts_synchronization_job.DtsSynchronizationJob(self, "default_1",
            data_initialization=cdktf.Token.as_boolean("true"),
            data_synchronization=cdktf.Token.as_boolean("true"),
            ...
            dts_instance_id=cdktf.Token.as_string(alicloud_dts_synchronization_instance_default.id),
            ...
            structure_initialization=cdktf.Token.as_boolean("true")
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        alicloud_dts_synchronization_job_default.override_logical_id("default")
```
