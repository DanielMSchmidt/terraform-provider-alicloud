...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        alicloud.instance.Instance(self, "instance",
            availability_zone=cdktf.Token.as_string(
                cdktf.property_access(data_alicloud_zones_default.zones, ["0", "id"])),
            data_disks=[InstanceDataDisks(
                category="cloud_efficiency",
                description="disk2",
                encrypted=True,
                kms_key_id=cdktf.Token.as_string(alicloud_kms_key_key.id),
                name="disk2",
                size=20
            )
            ],
            ...
            security_groups=cdktf.Token.as_list(
                cdktf.property_access(alicloud_security_group_group, ["*", "id"])),
