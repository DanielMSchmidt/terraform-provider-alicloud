...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        alicloud_express_connect_virtual_physical_connection_default =
        alicloud.express_connect_virtual_physical_connection.ExpressConnectVirtualPhysicalConnection(self, "default_1",
            description="amp_resource_test",
            order_mode="PayByPhysicalConnectionOwner",
            parent_physical_connection_id=cdktf.Token.as_string(
                cdktf.property_access(data_alicloud_express_connect_physical_connections_default.ids, ["0"])),
            spec="50M",
            virtual_physical_connection_name="amp_resource_test",
            vlan_id=789,
            vpconn_ali_uid=cdktf.Token.as_string(1234567890)
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        alicloud_express_connect_virtual_physical_connection_default.override_logical_id("default")
```
