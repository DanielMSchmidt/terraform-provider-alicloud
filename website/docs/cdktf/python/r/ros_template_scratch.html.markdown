...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        alicloud.ros_template_scratch.RosTemplateScratch(self, "example",
            description="tf_testacc",
            preference_parameters=[RosTemplateScratchPreferenceParameters(
                parameter_key="DeletionPolicy",
                parameter_value="Retain"
            )
            ],
            source_resource_group=RosTemplateScratchSourceResourceGroup(
