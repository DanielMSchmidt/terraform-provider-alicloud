...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        alicloud.express_connect_virtual_border_router.ExpressConnectVirtualBorderRouter(self, "example",
            ...
            physical_connection_id=cdktf.Token.as_string(
                cdktf.property_access(data_alicloud_express_connect_physical_connections_name_regex.connections, ["0", "id"])),
