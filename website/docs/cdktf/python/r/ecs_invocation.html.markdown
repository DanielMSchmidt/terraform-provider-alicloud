...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        alicloud_ecs_command_default = alicloud.ecs_command.EcsCommand(self, "default",
        ...
        alicloud.data_alicloud_instances.DataAlicloudInstances(self, "default_1",
            status="Running"
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        data_alicloud_instances_default.override_logical_id("default")
        alicloud_ecs_invocation_default =
        alicloud.ecs_invocation.EcsInvocation(self, "default_2",
            command_id=cdktf.Token.as_string(alicloud_ecs_command_default.id),
            instance_id=[
                cdktf.Token.as_string(
                    cdktf.property_access(data_alicloud_instances_default.ids, ["0"]))
            ]
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        alicloud_ecs_invocation_default.override_logical_id("default")
```
