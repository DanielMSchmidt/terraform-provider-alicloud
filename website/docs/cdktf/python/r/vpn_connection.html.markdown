...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        alicloud_vpn_customer_gateway_foo =
        alicloud.vpn_customer_gateway.VpnCustomerGateway(self, "foo_1",
            description="terraform-example",
            ip_address="42.104.22.210",
            name="terraform-example"
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        alicloud_vpn_customer_gateway_foo.override_logical_id("foo")
        ...
        alicloud_vpn_gateway_foo = alicloud.vpn_gateway.VpnGateway(self, "foo_4",
        ...
        alicloud_vpn_connection_foo = alicloud.vpn_connection.VpnConnection(self, "foo_5",
            customer_gateway_id=cdktf.Token.as_string(alicloud_vpn_customer_gateway_foo.id),
            effect_immediately=True,
            ike_config=VpnConnectionIkeConfig(
                ike_auth_alg="md5",
                ike_enc_alg="des",
                ike_lifetime=86400,
            ...
            ipsec_config=VpnConnectionIpsecConfig(
                ipsec_auth_alg="md5",
                ipsec_enc_alg="des",
                ipsec_lifetime=8640,
                ipsec_pfs="group5"
        ...
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        alicloud_vpn_connection_foo.override_logical_id("foo")
```
## Argument Reference
