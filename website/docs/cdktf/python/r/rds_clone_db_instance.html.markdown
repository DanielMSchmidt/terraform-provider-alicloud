...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        alicloud.data_alicloud_db_instance_classes.DataAlicloudDbInstanceClasses(self, "example_3",
            category="HighAvailability",
            db_instance_storage_type="cloud_essd",
            engine="PostgreSQL",
            engine_version="13.0",
        ...
        alicloud_rds_backup_example = alicloud.rds_backup.RdsBackup(self, "example_5",
            db_instance_id=cdktf.Token.as_string(alicloud_db_instance_example.id),
            remove_from_state=cdktf.Token.as_boolean("true")
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        alicloud_rds_backup_example.override_logical_id("example")
        alicloud_rds_clone_db_instance_example =
        alicloud.rds_clone_db_instance.RdsCloneDbInstance(self, "example_6",
            backup_id=cdktf.Token.as_string(alicloud_rds_backup_example.backup_id),
            db_instance_storage_type="cloud_essd",
            payment_type="PayAsYouGo",
            source_db_instance_id=cdktf.Token.as_string(alicloud_db_instance_example.id)
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        alicloud_rds_clone_db_instance_example.override_logical_id("example")
```
