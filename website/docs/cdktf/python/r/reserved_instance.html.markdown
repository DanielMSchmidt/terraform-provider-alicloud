...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        alicloud_reserved_instance_default =
        alicloud.reserved_instance.ReservedInstance(self, "default_1",
            description="ReservedInstance",
            instance_amount=cdktf.Token.as_number("1"),
            ...
            zone_id=cdktf.Token.as_string(
                cdktf.property_access(data_alicloud_instance_types_default.instance_types, ["0", "availability_zones", "0"
                ]))
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        alicloud_reserved_instance_default.override_logical_id("default")
```
