...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        alicloud.vpn_customer_gateway.VpnCustomerGateway(self, "default",
            ip_address="192.168.1.1",
            name=name.string_value
        )
        data_alicloud_vpn_gateways_default =
        alicloud.data_alicloud_vpn_gateways.DataAlicloudVpnGateways(self, "default_2")
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        data_alicloud_vpn_gateways_default.override_logical_id("default")
        alicloud_vpn_connection_default =
        alicloud.vpn_connection.VpnConnection(self, "default_3",
            customer_gateway_id=cdktf.Token.as_string(alicloud_vpn_customer_gateway_default.id),
            local_subnet=["192.168.2.0/24"],
            name=name.string_value,
            remote_subnet=["192.168.3.0/24"],
            vpn_gateway_id=cdktf.Token.as_string(
                cdktf.property_access(data_alicloud_vpn_gateways_default.ids, ["0"]))
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        alicloud_vpn_connection_default.override_logical_id("default")
        alicloud_vpn_pbr_route_entry_default =
        alicloud.vpn_pbr_route_entry.VpnPbrRouteEntry(self, "default_4",
        ...
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        alicloud_vpn_pbr_route_entry_default.override_logical_id("default")
```
## Argument Reference
