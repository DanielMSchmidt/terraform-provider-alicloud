...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        alicloud.data_alicloud_instance_types.DataAlicloudInstanceTypes(self, "default_5",
            availability_zone=cdktf.Token.as_string(
                cdktf.property_access(data_alicloud_zones_default.zones, ["0", "id"]))
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        data_alicloud_instance_types_default.override_logical_id("default")
        alicloud_ecs_launch_template_default =
        alicloud.ecs_launch_template.EcsLaunchTemplate(self, "default_6",
            data_disks=[EcsLaunchTemplateDataDisks(
                category="cloud",
                delete_with_instance=cdktf.Token.as_boolean("true"),
                description="description",
                encrypted=cdktf.Token.as_boolean("false"),
                name="disk1",
                performance_level="PL0",
                size=cdktf.Token.as_number("20")
            ), EcsLaunchTemplateDataDisks(
                category="cloud",
                delete_with_instance=cdktf.Token.as_boolean("true"),
            ...
            internet_max_bandwidth_in=cdktf.Token.as_number("5"),
            internet_max_bandwidth_out=cdktf.Token.as_number("5"),
            io_optimized="optimized",
            key_pair_name="key_pair_name",
            launch_template_name="terraform-example",
            network_interfaces=EcsLaunchTemplateNetworkInterfaces(
                description="hello1",
                name="eth0",
                primary_ip="10.0.0.2",
            ...
            spot_price_limit=cdktf.Token.as_number("5"),
            spot_strategy="SpotWithPriceLimit",
            system_disk=EcsLaunchTemplateSystemDisk(
                category="cloud_ssd",
                delete_with_instance=cdktf.Token.as_boolean("false"),
                description="Test For Terraform",
                name="terraform-example",
                size=cdktf.Token.as_number("40")
            ),
            template_tags={
                "Create": "Terraform",
                "For": "example"
        ...
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        alicloud_ecs_launch_template_default.override_logical_id("default")
```
