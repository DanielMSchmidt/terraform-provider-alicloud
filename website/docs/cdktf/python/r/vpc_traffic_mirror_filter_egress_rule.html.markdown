...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        alicloud_vpc_traffic_mirror_filter_example =
        alicloud.vpc_traffic_mirror_filter.VpcTrafficMirrorFilter(self, "example",
            traffic_mirror_filter_name="example_value"
        )
        alicloud_vpc_traffic_mirror_filter_egress_rule_example =
        alicloud.vpc_traffic_mirror_filter_egress_rule.VpcTrafficMirrorFilterEgressRule(self, "example_1",
            ...
            traffic_mirror_filter_id=cdktf.Token.as_string(alicloud_vpc_traffic_mirror_filter_example.id)
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        alicloud_vpc_traffic_mirror_filter_egress_rule_example.override_logical_id("example")
```
