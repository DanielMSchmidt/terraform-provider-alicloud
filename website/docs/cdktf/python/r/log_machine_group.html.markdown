...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        alicloud_log_machine_group_example =
        alicloud.log_machine_group.LogMachineGroup(self, "example_1",
        ...
        alicloud_log_machine_group_example.override_logical_id("example")
```
