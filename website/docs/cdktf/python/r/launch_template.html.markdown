...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_images_images =
        alicloud.data_alicloud_images.DataAlicloudImages(self, "images",
            owners="system"
        )
        data_alicloud_instances_instances =
        alicloud.data_alicloud_instances.DataAlicloudInstances(self, "instances")
        alicloud.launch_template.LaunchTemplate(self, "template",
            data_disks=[LaunchTemplateDataDisks(
                description="test1",
                name="disk1"
            ), LaunchTemplateDataDisks(
                description="test2",
                name="disk2"
            )
            ],
            ...
            image_id=cdktf.Token.as_string(
                cdktf.property_access(data_alicloud_images_images.images, ["0", "id"])),
            instance_charge_type="PrePaid",
            instance_name="tf-instance-name",
            instance_type=cdktf.Token.as_string(
                cdktf.property_access(data_alicloud_instances_instances.instances, ["0", "instance_type"
                ])),
