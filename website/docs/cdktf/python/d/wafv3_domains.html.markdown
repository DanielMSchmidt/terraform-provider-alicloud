...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_wafv3_domains_default =
        alicloud.data_alicloud_wafv3_domains.DataAlicloudWafv3Domains(self, "default",
            domain="zctest12.wafqax.top",
            instance_id="waf_v3prepaid_public_cn-*****"
        )
        cdktf.TerraformOutput(self, "alicloud_wafv3_domain_example_id",
            value=cdktf.property_access(data_alicloud_wafv3_domains_default.domains, ["0", "id"
            ])
        )
```
