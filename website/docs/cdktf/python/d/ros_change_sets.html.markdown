...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_ros_change_sets_example =
        alicloud.data_alicloud_ros_change_sets.DataAlicloudRosChangeSets(self, "example",
            ids=["example_value"],
            name_regex="the_resource_name",
            stack_id="example_value"
        )
        cdktf.TerraformOutput(self, "first_ros_change_set_id",
            value=cdktf.property_access(data_alicloud_ros_change_sets_example.sets, ["0", "id"
            ])
        )
```
