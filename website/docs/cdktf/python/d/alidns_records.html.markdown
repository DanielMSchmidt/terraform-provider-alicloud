...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_alidns_records_records_ds =
        alicloud.data_alicloud_alidns_records.DataAlicloudAlidnsRecords(self, "records_ds",
        ...
        cdktf.TerraformOutput(self, "first_record_id",
            value=cdktf.property_access(data_alicloud_alidns_records_records_ds.records, ["0", "record_id"
            ])
        )
```
