...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_simple_application_server_firewall_rules_ids =
        alicloud.data_alicloud_simple_application_server_firewall_rules.DataAlicloudSimpleApplicationServerFirewallRules(self, "ids",
            ids=["example_value-1", "example_value-2"],
            instance_id="example_value"
        )
        cdktf.TerraformOutput(self, "simple_application_server_firewall_rule_id_1",
            value=cdktf.property_access(data_alicloud_simple_application_server_firewall_rules_ids.rules, ["0", "id"])
        )
```
