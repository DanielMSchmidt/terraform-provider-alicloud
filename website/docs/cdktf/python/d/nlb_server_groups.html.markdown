...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_nlb_server_groups_ids =
        alicloud.data_alicloud_nlb_server_groups.DataAlicloudNlbServerGroups(self, "ids")
        data_alicloud_nlb_server_groups_name_regex =
        alicloud.data_alicloud_nlb_server_groups.DataAlicloudNlbServerGroups(self, "nameRegex",
            name_regex="^my-ServerGroup"
        )
        cdktf.TerraformOutput(self, "nlb_server_group_id_1",
            value=cdktf.property_access(data_alicloud_nlb_server_groups_ids.groups, ["0", "id"
            ])
        )
        cdktf.TerraformOutput(self, "nlb_server_group_id_2",
            value=cdktf.property_access(data_alicloud_nlb_server_groups_name_regex.groups, ["0", "id"
            ])
        )
```
