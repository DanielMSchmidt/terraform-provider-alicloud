...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_ga_endpoint_groups_example =
        alicloud.data_alicloud_ga_endpoint_groups.DataAlicloudGaEndpointGroups(self, "example",
            accelerator_id="example_value",
            ids=["example_value"],
            name_regex="the_resource_name"
        )
        cdktf.TerraformOutput(self, "first_ga_endpoint_group_id",
            value=cdktf.property_access(data_alicloud_ga_endpoint_groups_example.groups, ["0", "id"
            ])
        )
```
