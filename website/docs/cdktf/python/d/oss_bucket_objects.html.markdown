...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_oss_bucket_objects_bucket_objects_ds =
        alicloud.data_alicloud_oss_bucket_objects.DataAlicloudOssBucketObjects(self, "bucket_objects_ds",
            bucket_name="sample_bucket",
            key_regex="sample/sample_object.txt"
        )
        cdktf.TerraformOutput(self, "first_object_key",
            value=cdktf.property_access(data_alicloud_oss_bucket_objects_bucket_objects_ds.objects, ["0", "key"])
        )
```
