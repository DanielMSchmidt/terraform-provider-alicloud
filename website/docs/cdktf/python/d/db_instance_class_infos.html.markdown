...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_db_instance_class_infos_resources =
        alicloud.data_alicloud_db_instance_class_infos.DataAlicloudDbInstanceClassInfos(self, "resources",
            commodity_code="bards",
            order_type="BUY",
            output_file="./classes.txt"
        )
        cdktf.TerraformOutput(self, "first_db_instance_class",
            value=cdktf.property_access(data_alicloud_db_instance_class_infos_resources.infos, ["0"])
        )
```
