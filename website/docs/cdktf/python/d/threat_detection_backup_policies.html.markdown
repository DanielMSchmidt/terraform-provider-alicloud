...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_threat_detection_backup_policies_ids =
        alicloud.data_alicloud_threat_detection_backup_policies.DataAlicloudThreatDetectionBackupPolicies(self, "ids",
            ids=["example_id"]
        )
        data_alicloud_threat_detection_backup_policies_name_regex =
        alicloud.data_alicloud_threat_detection_backup_policies.DataAlicloudThreatDetectionBackupPolicies(self, "nameRegex",
            name_regex="tf-example"
        )
        cdktf.TerraformOutput(self, "threat_detection_backup_policies_id_1",
            value=cdktf.property_access(data_alicloud_threat_detection_backup_policies_ids.policies, ["0", "id"])
        )
        cdktf.TerraformOutput(self, "threat_detection_backup_policies_id_2",
            value=cdktf.property_access(data_alicloud_threat_detection_backup_policies_name_regex.policies, ["0", "id"])
        )
```
