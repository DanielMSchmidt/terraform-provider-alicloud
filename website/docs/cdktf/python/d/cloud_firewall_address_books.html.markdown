...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_cloud_firewall_address_books_ids =
        alicloud.data_alicloud_cloud_firewall_address_books.DataAlicloudCloudFirewallAddressBooks(self, "ids")
        cdktf.TerraformOutput(self, "cloud_firewall_address_book_id_1",
            value=cdktf.property_access(data_alicloud_cloud_firewall_address_books_ids.books, ["0", "id"])
        )
```
