...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        alicloud_video_surveillance_system_group_default =
        alicloud.video_surveillance_system_group.VideoSurveillanceSystemGroup(self, "default",
        ...
        data_alicloud_video_surveillance_system_groups_default =
        alicloud.data_alicloud_video_surveillance_system_groups.DataAlicloudVideoSurveillanceSystemGroups(self, "default_1",
            ids=[
                cdktf.Token.as_string(alicloud_video_surveillance_system_group_default.id)
            ]
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        data_alicloud_video_surveillance_system_groups_default.override_logical_id("default")
        cdktf.TerraformOutput(self, "vs_group",
            value=cdktf.property_access(data_alicloud_video_surveillance_system_groups_default.ids, ["0"])
        )
```
