...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_cen_transit_route_table_aggregations_ids =
        alicloud.data_alicloud_cen_transit_route_table_aggregations.DataAlicloudCenTransitRouteTableAggregations(self, "ids",
            ids=["example_id"],
            transit_route_table_id="your_transit_route_table_id"
        )
        data_alicloud_cen_transit_route_table_aggregations_name_regex =
        alicloud.data_alicloud_cen_transit_route_table_aggregations.DataAlicloudCenTransitRouteTableAggregations(self, "nameRegex",
            name_regex="^my-name",
            transit_route_table_id="your_transit_route_table_id"
        )
        cdktf.TerraformOutput(self, "cen_transit_router_multicast_domain_id_0",
            value=cdktf.property_access(data_alicloud_cen_transit_route_table_aggregations_ids.transit_route_table_aggregations, ["0", "id"])
        )
        cdktf.TerraformOutput(self, "cen_transit_router_multicast_domain_id_1",
            value=cdktf.property_access(data_alicloud_cen_transit_route_table_aggregations_name_regex.transit_route_table_aggregations, ["0", "id"])
        )
```
