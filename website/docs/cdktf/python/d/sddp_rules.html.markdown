...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        alicloud_sddp_rule_default = alicloud.sddp_rule.SddpRule(self, "default",
            category=cdktf.Token.as_number("0"),
            content="content",
            product_code="ODPS",
            risk_level_id="4",
            rule_name="rule_name"
        )
        data_alicloud_sddp_rules_default =
        alicloud.data_alicloud_sddp_rules.DataAlicloudSddpRules(self, "default_1",
            ids=[cdktf.Token.as_string(alicloud_sddp_rule_default.id)]
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        data_alicloud_sddp_rules_default.override_logical_id("default")
        cdktf.TerraformOutput(self, "sddp_rule_id",
            value=data_alicloud_sddp_rules_default.id
        )
```
