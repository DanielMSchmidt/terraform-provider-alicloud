...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_alb_rules_ids =
        alicloud.data_alicloud_alb_rules.DataAlicloudAlbRules(self, "ids",
            ids=["example_id"]
        )
        data_alicloud_alb_rules_name_regex =
        alicloud.data_alicloud_alb_rules.DataAlicloudAlbRules(self, "nameRegex",
            name_regex="^my-Rule"
        )
        cdktf.TerraformOutput(self, "alb_rule_id_1",
            value=cdktf.property_access(data_alicloud_alb_rules_ids.rules, ["0", "id"])
        )
        cdktf.TerraformOutput(self, "alb_rule_id_2",
            value=cdktf.property_access(data_alicloud_alb_rules_name_regex.rules, ["0", "id"
            ])
        )
```
