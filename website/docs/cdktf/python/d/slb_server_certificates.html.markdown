...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_slb_server_certificates_sample_ds =
        alicloud.data_alicloud_slb_server_certificates.DataAlicloudSlbServerCertificates(self, "sample_ds")
        cdktf.TerraformOutput(self, "first_slb_server_certificate_id",
            value=cdktf.property_access(data_alicloud_slb_server_certificates_sample_ds.certificates, ["0", "id"])
        )
```
