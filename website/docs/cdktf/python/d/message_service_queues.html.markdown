...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_message_service_queues_ids =
        alicloud.data_alicloud_message_service_queues.DataAlicloudMessageServiceQueues(self, "ids",
            ids=["example_id"]
        )
        data_alicloud_message_service_queues_name =
        alicloud.data_alicloud_message_service_queues.DataAlicloudMessageServiceQueues(self, "name",
            queue_name="tf-example"
        )
        cdktf.TerraformOutput(self, "queue_id_1",
            value=cdktf.property_access(data_alicloud_message_service_queues_ids.queues, ["0", "id"
            ])
        )
        cdktf.TerraformOutput(self, "queue_id_2",
            value=cdktf.property_access(data_alicloud_message_service_queues_name.queues, ["0", "id"
            ])
        )
```
