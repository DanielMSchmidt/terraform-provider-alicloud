...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_nlb_load_balancers_ids =
        alicloud.data_alicloud_nlb_load_balancers.DataAlicloudNlbLoadBalancers(self, "ids",
            ids=["example_id"]
        )
        data_alicloud_nlb_load_balancers_name_regex =
        alicloud.data_alicloud_nlb_load_balancers.DataAlicloudNlbLoadBalancers(self, "nameRegex",
            name_regex="^my-LoadBalancer"
        )
        cdktf.TerraformOutput(self, "nlb_load_balancer_id_1",
            value=cdktf.property_access(data_alicloud_nlb_load_balancers_ids.balancers, ["0", "id"
            ])
        )
        cdktf.TerraformOutput(self, "nlb_load_balancer_id_2",
            value=cdktf.property_access(data_alicloud_nlb_load_balancers_name_regex.balancers, ["0", "id"])
        )
```
