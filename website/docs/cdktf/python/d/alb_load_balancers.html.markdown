...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_alb_load_balancers_ids =
        alicloud.data_alicloud_alb_load_balancers.DataAlicloudAlbLoadBalancers(self, "ids")
        data_alicloud_alb_load_balancers_name_regex =
        alicloud.data_alicloud_alb_load_balancers.DataAlicloudAlbLoadBalancers(self, "nameRegex",
            name_regex="^my-LoadBalancer"
        )
        cdktf.TerraformOutput(self, "alb_load_balancer_id_1",
            value=cdktf.property_access(data_alicloud_alb_load_balancers_ids.balancers, ["0", "id"
            ])
        )
        cdktf.TerraformOutput(self, "alb_load_balancer_id_2",
            value=cdktf.property_access(data_alicloud_alb_load_balancers_name_regex.balancers, ["0", "id"])
        )
```
