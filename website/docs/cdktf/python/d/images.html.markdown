...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_images_images_ds =
        alicloud.data_alicloud_images.DataAlicloudImages(self, "images_ds",
            name_regex="^centos_6",
            owners="system"
        )
        cdktf.TerraformOutput(self, "first_image_id",
            value=cdktf.property_access(data_alicloud_images_images_ds.images, ["0", "id"
            ])
        )
```
