...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_ecd_snapshots_ids =
        alicloud.data_alicloud_ecd_snapshots.DataAlicloudEcdSnapshots(self, "ids")
        cdktf.TerraformOutput(self, "ecd_snapshot_id_1",
            value=cdktf.property_access(data_alicloud_ecd_snapshots_ids.snapshots, ["0", "id"
            ])
        )
```
