...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_hbr_server_backup_plans_ids =
        alicloud.data_alicloud_hbr_server_backup_plans.DataAlicloudHbrServerBackupPlans(self, "ids",
            filters=[DataAlicloudHbrServerBackupPlansFilters(
                key="instanceId",
                values=[
        ...
        cdktf.TerraformOutput(self, "hbr_server_backup_plan_id_1",
            value=cdktf.property_access(data_alicloud_hbr_server_backup_plans_ids.plans, ["0", "id"
            ])
        )
```
