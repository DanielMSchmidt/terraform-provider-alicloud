...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_cen_child_instance_route_entry_to_attachments_default =
        alicloud.data_alicloud_cen_child_instance_route_entry_to_attachments.DataAlicloudCenChildInstanceRouteEntryToAttachments(self, "default",
            child_instance_route_table_id="vtb-t4nt0z5xxbti85c78nkzy",
            transit_router_attachment_id="tr-attach-f1fd1y50rql00emvej"
        )
        cdktf.TerraformOutput(self, "alicloud_cen_child_instance_route_entry_to_attachment_example_id",
            value=cdktf.property_access(data_alicloud_cen_child_instance_route_entry_to_attachments_default.attachments, ["0", "id"])
        )
```
