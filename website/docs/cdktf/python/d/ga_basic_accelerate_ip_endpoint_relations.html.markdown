...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_ga_basic_accelerate_ip_endpoint_relations_ids =
        alicloud.data_alicloud_ga_basic_accelerate_ip_endpoint_relations.DataAlicloudGaBasicAccelerateIpEndpointRelations(self, "ids",
            accelerator_id="example_id",
            ids=["example_id"]
        )
        cdktf.TerraformOutput(self, "ga_basic_accelerate_ip_endpoint_relations_id_1",
            value=cdktf.property_access(data_alicloud_ga_basic_accelerate_ip_endpoint_relations_ids.relations, ["0", "id"])
        )
```
