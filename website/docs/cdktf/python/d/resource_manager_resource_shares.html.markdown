...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_resource_manager_resource_shares_example =
        alicloud.data_alicloud_resource_manager_resource_shares.DataAlicloudResourceManagerResourceShares(self, "example",
            ids=["example_value"],
            name_regex="the_resource_name",
            resource_share_owner="Self"
        )
        cdktf.TerraformOutput(self, "first_resource_manager_resource_share_id",
            value=cdktf.property_access(data_alicloud_resource_manager_resource_shares_example.shares, ["0", "id"])
        )
```
