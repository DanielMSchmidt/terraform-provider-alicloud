...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_ecs_image_pipelines_ids =
        alicloud.data_alicloud_ecs_image_pipelines.DataAlicloudEcsImagePipelines(self, "ids",
            ids=["example_value"]
        )
        data_alicloud_ecs_image_pipelines_name_regex =
        alicloud.data_alicloud_ecs_image_pipelines.DataAlicloudEcsImagePipelines(self, "nameRegex",
            name_regex="^my-ImagePipeline"
        )
        cdktf.TerraformOutput(self, "ecs_image_pipeline_id_1",
            value=cdktf.property_access(data_alicloud_ecs_image_pipelines_ids.pipelines, ["0", "id"
            ])
        )
        cdktf.TerraformOutput(self, "ecs_image_pipeline_id_2",
            value=cdktf.property_access(data_alicloud_ecs_image_pipelines_name_regex.pipelines, ["0", "id"])
        )
```
