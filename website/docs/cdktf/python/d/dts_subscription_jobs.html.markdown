...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_dts_subscription_jobs_ids =
        alicloud.data_alicloud_dts_subscription_jobs.DataAlicloudDtsSubscriptionJobs(self, "ids")
        cdktf.TerraformOutput(self, "dts_subscription_job_id_1",
            value=cdktf.property_access(data_alicloud_dts_subscription_jobs_ids.jobs, ["0", "id"
            ])
        )
```
