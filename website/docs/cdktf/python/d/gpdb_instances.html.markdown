...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_gpdb_instances_ids =
        alicloud.data_alicloud_gpdb_instances.DataAlicloudGpdbInstances(self, "ids")
        cdktf.TerraformOutput(self, "gpdb_db_instance_id_1",
            value=cdktf.property_access(data_alicloud_gpdb_instances_ids.instances, ["0", "id"
            ])
        )
```
