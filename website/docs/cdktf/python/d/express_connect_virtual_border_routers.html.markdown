...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_express_connect_virtual_border_routers_filter =
        alicloud.data_alicloud_express_connect_virtual_border_routers.DataAlicloudExpressConnectVirtualBorderRouters(self, "filter",
            filter=[DataAlicloudExpressConnectVirtualBorderRoutersFilter(
                key="PhysicalConnectionId",
                values=["pc-xxxx1"]
            ), DataAlicloudExpressConnectVirtualBorderRoutersFilter(
                key="VbrId",
                values=["vbr-xxxx1", "vbr-xxxx2"]
            )
            ]
        )
        data_alicloud_express_connect_virtual_border_routers_ids =
        alicloud.data_alicloud_express_connect_virtual_border_routers.DataAlicloudExpressConnectVirtualBorderRouters(self, "ids")
        data_alicloud_express_connect_virtual_border_routers_name_regex =
        alicloud.data_alicloud_express_connect_virtual_border_routers.DataAlicloudExpressConnectVirtualBorderRouters(self, "nameRegex",
            name_regex="^my-VirtualBorderRouter"
        )
        cdktf.TerraformOutput(self, "express_connect_virtual_border_router_id_1",
            value=cdktf.property_access(data_alicloud_express_connect_virtual_border_routers_ids.routers, ["0", "id"])
        )
        cdktf.TerraformOutput(self, "express_connect_virtual_border_router_id_2",
            value=cdktf.property_access(data_alicloud_express_connect_virtual_border_routers_name_regex.routers, ["0", "id"])
        )
        cdktf.TerraformOutput(self, "express_connect_virtual_border_router_id_3",
            value=cdktf.property_access(data_alicloud_express_connect_virtual_border_routers_filter.routers, ["0", "id"])
        )
```
