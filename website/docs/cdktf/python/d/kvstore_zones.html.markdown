...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_kvstore_zones_zones_ids =
        alicloud.data_alicloud_kvstore_zones.DataAlicloudKvstoreZones(self, "zones_ids")
        alicloud.kvstore_instance.KvstoreInstance(self, "kvstore",
            availability_zone=cdktf.Token.as_string(
                cdktf.property_access(data_alicloud_kvstore_zones_zones_ids.zones, ["0", "id"
                ]))
        )
```
