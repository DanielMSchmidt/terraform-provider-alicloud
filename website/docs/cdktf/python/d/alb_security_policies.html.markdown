...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_alb_security_policies_ids =
        alicloud.data_alicloud_alb_security_policies.DataAlicloudAlbSecurityPolicies(self, "ids")
        data_alicloud_alb_security_policies_name_regex =
        alicloud.data_alicloud_alb_security_policies.DataAlicloudAlbSecurityPolicies(self, "nameRegex",
            name_regex="^my-SecurityPolicy"
        )
        cdktf.TerraformOutput(self, "alb_security_policy_id_1",
            value=cdktf.property_access(data_alicloud_alb_security_policies_ids.policies, ["0", "id"
            ])
        )
        cdktf.TerraformOutput(self, "alb_security_policy_id_2",
            value=cdktf.property_access(data_alicloud_alb_security_policies_name_regex.policies, ["0", "id"])
        )
```
