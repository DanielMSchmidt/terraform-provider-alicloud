...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_direct_mail_domains_example =
        alicloud.data_alicloud_direct_mail_domains.DataAlicloudDirectMailDomains(self, "example",
            ids=["example_id"],
            key_word="^my-Domain",
            status="1"
        )
        data_alicloud_direct_mail_domains_ids =
        alicloud.data_alicloud_direct_mail_domains.DataAlicloudDirectMailDomains(self, "ids",
            ids=["example_id"]
        )
        data_alicloud_direct_mail_domains_name_regex =
        alicloud.data_alicloud_direct_mail_domains.DataAlicloudDirectMailDomains(self, "nameRegex",
            name_regex="^my-Domain"
        )
        cdktf.TerraformOutput(self, "direct_mail_domain_id_1",
            value=cdktf.property_access(data_alicloud_direct_mail_domains_ids.domains, ["0", "id"
            ])
        )
        cdktf.TerraformOutput(self, "direct_mail_domain_id_2",
            value=cdktf.property_access(data_alicloud_direct_mail_domains_name_regex.domains, ["0", "id"])
        )
        cdktf.TerraformOutput(self, "direct_mail_domain_id_3",
            value=cdktf.property_access(data_alicloud_direct_mail_domains_example.domains, ["0", "id"])
        )
```
