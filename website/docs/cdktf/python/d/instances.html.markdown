...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_instances_instances_ds =
        alicloud.data_alicloud_instances.DataAlicloudInstances(self, "instances_ds",
            name_regex="web_server",
            status="Running"
        )
        cdktf.TerraformOutput(self, "first_instance_id",
            value=cdktf.property_access(data_alicloud_instances_instances_ds.instances, ["0", "id"
            ])
        )
        cdktf.TerraformOutput(self, "instance_ids",
            value=data_alicloud_instances_instances_ds.ids
        )
```
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        alicloud.data_alicloud_instances.DataAlicloudInstances(self, "taggedInstances",
            tags={
                "tag_key1": "tagValue1",
                "tag_key2": "tagValue2"
            }
