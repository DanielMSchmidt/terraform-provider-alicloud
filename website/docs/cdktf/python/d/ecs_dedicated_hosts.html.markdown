...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_ecs_dedicated_hosts_dedicated_hosts_ds =
        alicloud.data_alicloud_ecs_dedicated_hosts.DataAlicloudEcsDedicatedHosts(self, "dedicated_hosts_ds",
            dedicated_host_type="ddh.g5",
            name_regex="tf-testAcc",
            status="Available"
        )
        cdktf.TerraformOutput(self, "first_dedicated_hosts_id",
            value=cdktf.property_access(data_alicloud_ecs_dedicated_hosts_dedicated_hosts_ds.hosts, ["0", "id"])
        )
```
