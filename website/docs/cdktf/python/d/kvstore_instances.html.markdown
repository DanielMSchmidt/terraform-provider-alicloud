...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_kvstore_instances_default =
        alicloud.data_alicloud_kvstore_instances.DataAlicloudKvstoreInstances(self, "default",
            name_regex="testname"
        )
        cdktf.TerraformOutput(self, "first_instance_name",
            value=cdktf.property_access(data_alicloud_kvstore_instances_default.instances, ["0", "name"])
        )
```
