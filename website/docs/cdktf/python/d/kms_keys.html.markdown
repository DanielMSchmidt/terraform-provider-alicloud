...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_kms_keys_kms_keys_ds =
        alicloud.data_alicloud_kms_keys.DataAlicloudKmsKeys(self, "kms_keys_ds",
            description_regex="Hello KMS",
            output_file="kms_keys.json"
        )
        cdktf.TerraformOutput(self, "first_key_id",
            value=cdktf.property_access(data_alicloud_kms_keys_kms_keys_ds.keys, ["0", "id"
            ])
        )
```
