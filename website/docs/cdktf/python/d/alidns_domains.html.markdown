...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_alidns_domains_domains_ds =
        alicloud.data_alicloud_alidns_domains.DataAlicloudAlidnsDomains(self, "domains_ds",
            domain_name_regex="^hegu",
            output_file="domains.txt"
        )
        cdktf.TerraformOutput(self, "first_domain_id",
            value=cdktf.property_access(data_alicloud_alidns_domains_domains_ds.domains, ["0", "domain_id"
            ])
        )
```
