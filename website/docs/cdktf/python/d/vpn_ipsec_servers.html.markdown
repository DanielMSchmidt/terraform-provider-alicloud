...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_vpn_ipsec_servers_ids =
        alicloud.data_alicloud_vpn_ipsec_servers.DataAlicloudVpnIpsecServers(self, "ids",
            ids=["example_id"]
        )
        data_alicloud_vpn_ipsec_servers_name_regex =
        alicloud.data_alicloud_vpn_ipsec_servers.DataAlicloudVpnIpsecServers(self, "nameRegex",
            name_regex="^my-IpsecServer"
        )
        cdktf.TerraformOutput(self, "vpn_ipsec_server_id_1",
            value=cdktf.property_access(data_alicloud_vpn_ipsec_servers_ids.servers, ["0", "id"
            ])
        )
        cdktf.TerraformOutput(self, "vpn_ipsec_server_id_2",
            value=cdktf.property_access(data_alicloud_vpn_ipsec_servers_name_regex.servers, ["0", "id"])
        )
```
