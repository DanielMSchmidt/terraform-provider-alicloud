...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        alicloud.sae_application.SaeApplication(self, "default_5",
            ...
            namespace_id=cdktf.Token.as_string(alicloud_sae_namespace_default.id),
            package_type="Image",
        ...
        data_alicloud_sae_applications_default =
        alicloud.data_alicloud_sae_applications.DataAlicloudSaeApplications(self, "default_6",
            ids=[cdktf.Token.as_string(alicloud_sae_application_default.id)]
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        data_alicloud_sae_applications_default.override_logical_id("default")
        cdktf.TerraformOutput(self, "sae_application_id",
            value=cdktf.property_access(data_alicloud_sae_applications_default.applications, ["0", "id"])
        )
```
