...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        alicloud.data_alicloud_vpc_traffic_mirror_service.DataAlicloudVpcTrafficMirrorService(self, "open",
            enable="On"
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-8133100a7b151b238866582c82a0f33406f3c5c14cafce03f17d3f1682f6937c -->