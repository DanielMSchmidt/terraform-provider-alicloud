...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_hbr_hana_backup_plans_ids =
        alicloud.data_alicloud_hbr_hana_backup_plans.DataAlicloudHbrHanaBackupPlans(self, "ids",
            cluster_id="example_value",
            ids=["example_value-1", "example_value-2"]
        )
        cdktf.TerraformOutput(self, "hbr_hana_backup_plan_id_1",
            value=cdktf.property_access(data_alicloud_hbr_hana_backup_plans_ids.plans, ["0", "id"
            ])
        )
```
