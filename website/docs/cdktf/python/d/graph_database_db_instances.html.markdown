...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_graph_database_db_instances_description =
        alicloud.data_alicloud_graph_database_db_instances.DataAlicloudGraphDatabaseDbInstances(self, "description",
            db_instance_description="example_value",
            ids=["example_id"]
        )
        data_alicloud_graph_database_db_instances_ids =
        alicloud.data_alicloud_graph_database_db_instances.DataAlicloudGraphDatabaseDbInstances(self, "ids",
            ids=["example_id"]
        )
        data_alicloud_graph_database_db_instances_status =
        alicloud.data_alicloud_graph_database_db_instances.DataAlicloudGraphDatabaseDbInstances(self, "status",
            ids=["example_id"],
            status="Running"
        )
        cdktf.TerraformOutput(self, "graph_database_db_instance_id_1",
            value=cdktf.property_access(data_alicloud_graph_database_db_instances_ids.instances, ["0", "id"])
        )
        cdktf.TerraformOutput(self, "graph_database_db_instance_id_2",
            value=cdktf.property_access(data_alicloud_graph_database_db_instances_status.instances, ["0", "id"])
        )
        cdktf.TerraformOutput(self, "graph_database_db_instance_id_3",
            value=cdktf.property_access(data_alicloud_graph_database_db_instances_description.instances, ["0", "id"])
        )
```
