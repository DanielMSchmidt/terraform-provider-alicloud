...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_kms_secrets_kms_secrets_ds =
        alicloud.data_alicloud_kms_secrets.DataAlicloudKmsSecrets(self, "kms_secrets_ds",
            fetch_tags=True,
        ...
        cdktf.TerraformOutput(self, "first_secret_id",
            value=cdktf.property_access(data_alicloud_kms_secrets_kms_secrets_ds.secrets, ["0", "id"
            ])
        )
```
