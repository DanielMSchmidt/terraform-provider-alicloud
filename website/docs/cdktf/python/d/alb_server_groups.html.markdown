...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_alb_server_groups_ids =
        alicloud.data_alicloud_alb_server_groups.DataAlicloudAlbServerGroups(self, "ids")
        data_alicloud_alb_server_groups_name_regex =
        alicloud.data_alicloud_alb_server_groups.DataAlicloudAlbServerGroups(self, "nameRegex",
            name_regex="^my-ServerGroup"
        )
        cdktf.TerraformOutput(self, "alb_server_group_id_1",
            value=cdktf.property_access(data_alicloud_alb_server_groups_ids.groups, ["0", "id"
            ])
        )
        cdktf.TerraformOutput(self, "alb_server_group_id_2",
            value=cdktf.property_access(data_alicloud_alb_server_groups_name_regex.groups, ["0", "id"
            ])
        )
```
