...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_cddc_dedicated_host_groups_default =
        alicloud.data_alicloud_cddc_dedicated_host_groups.DataAlicloudCddcDedicatedHostGroups(self, "default",
            engine="MongoDB"
        )
        cdktf.TerraformOutput(self, "cddc_dedicated_host_group_id",
            value=data_alicloud_cddc_dedicated_host_groups_default.id
        )
```
