...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_rds_cross_region_backups_backups =
        alicloud.data_alicloud_rds_cross_region_backups.DataAlicloudRdsCrossRegionBackups(self, "backups",
            db_instance_id="example_value",
            end_time="2022-12-16T00:00:00Z",
            start_time="2022-12-01T00:00:00Z"
        )
        cdktf.TerraformOutput(self, "first_rds_cross_region_backups",
            value=cdktf.property_access(data_alicloud_rds_cross_region_backups_backups.backups, ["0", "id"])
        )
```
