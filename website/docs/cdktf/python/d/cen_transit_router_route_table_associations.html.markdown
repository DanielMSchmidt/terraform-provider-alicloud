...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_cen_transit_router_route_table_associations_default =
        alicloud.data_alicloud_cen_transit_router_route_table_associations.DataAlicloudCenTransitRouterRouteTableAssociations(self, "default",
        ...
        cdktf.TerraformOutput(self, "first_transit_router_peer_attachments_transit_router_attachment_resource_type",
            value=cdktf.property_access(data_alicloud_cen_transit_router_route_table_associations_default.associations, ["0", "resource_type"])
        )
```
