...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_ecd_ad_connector_office_sites_ids =
        alicloud.data_alicloud_ecd_ad_connector_office_sites.DataAlicloudEcdAdConnectorOfficeSites(self, "ids")
        data_alicloud_ecd_ad_connector_office_sites_name_regex =
        alicloud.data_alicloud_ecd_ad_connector_office_sites.DataAlicloudEcdAdConnectorOfficeSites(self, "nameRegex",
            name_regex="^my-AdConnectorOfficeSite"
        )
        cdktf.TerraformOutput(self, "ecd_ad_connector_office_site_id_1",
            value=cdktf.property_access(data_alicloud_ecd_ad_connector_office_sites_ids.sites, ["0", "id"])
        )
        cdktf.TerraformOutput(self, "ecd_ad_connector_office_site_id_2",
            value=cdktf.property_access(data_alicloud_ecd_ad_connector_office_sites_name_regex.sites, ["0", "id"])
        )
```
