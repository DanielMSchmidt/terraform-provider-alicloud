...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_kms_key_versions_alicloud_kms_key_versions_ds =
        alicloud.data_alicloud_kms_key_versions.DataAlicloudKmsKeyVersions(self, "alicloud_kms_key_versions_ds",
            ids=["d89e8a53-b708-41aa-8c67-6873axxx"],
            key_id="08438c-b4d5-4d05-928c-07b7xxxx"
        )
        cdktf.TerraformOutput(self, "all_versions",
            value=data_alicloud_kms_key_versions_alicloud_kms_key_versions_ds.versions
        )
```
