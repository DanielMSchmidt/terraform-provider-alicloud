...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_dts_synchronization_jobs_ids =
        alicloud.data_alicloud_dts_synchronization_jobs.DataAlicloudDtsSynchronizationJobs(self, "ids")
        cdktf.TerraformOutput(self, "dts_synchronization_job_id_1",
            value=cdktf.property_access(data_alicloud_dts_synchronization_jobs_ids.jobs, ["0", "id"
            ])
        )
```
