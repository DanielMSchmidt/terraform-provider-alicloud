...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        alicloud.data_alicloud_log_alert_resource.DataAlicloudLogAlertResource(self, "example_project",
            project="test-alert-tf",
            type="project"
        )
        alicloud.data_alicloud_log_alert_resource.DataAlicloudLogAlertResource(self, "example_user",
            lang="cn",
            type="user"
        )
```
