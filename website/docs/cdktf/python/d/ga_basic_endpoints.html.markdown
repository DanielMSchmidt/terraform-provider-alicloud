...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_ga_basic_endpoints_ids =
        alicloud.data_alicloud_ga_basic_endpoints.DataAlicloudGaBasicEndpoints(self, "ids",
            endpoint_group_id="example_id",
            ids=["example_id"]
        )
        data_alicloud_ga_basic_endpoints_name_regex =
        alicloud.data_alicloud_ga_basic_endpoints.DataAlicloudGaBasicEndpoints(self, "nameRegex",
            endpoint_group_id="example_id",
            name_regex="tf-example"
        )
        cdktf.TerraformOutput(self, "ga_basic_endpoints_id_1",
            value=cdktf.property_access(data_alicloud_ga_basic_endpoints_ids.endpoints, ["0", "id"
            ])
        )
        cdktf.TerraformOutput(self, "ga_basic_endpoints_id_2",
            value=cdktf.property_access(data_alicloud_ga_basic_endpoints_name_regex.endpoints, ["0", "id"])
        )
```
