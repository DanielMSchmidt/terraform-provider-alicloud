...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_config_aggregate_deliveries_ids =
        alicloud.data_alicloud_config_aggregate_deliveries.DataAlicloudConfigAggregateDeliveries(self, "ids",
            aggregator_id="example_value",
            ids=["example_value-1", "example_value-2"]
        )
        cdktf.TerraformOutput(self, "config_aggregate_delivery_id_1",
            value=cdktf.property_access(data_alicloud_config_aggregate_deliveries_ids.deliveries, ["0", "id"])
        )
```
