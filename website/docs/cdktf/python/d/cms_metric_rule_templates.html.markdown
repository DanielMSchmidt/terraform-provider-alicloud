...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_cms_metric_rule_templates_ids =
        alicloud.data_alicloud_cms_metric_rule_templates.DataAlicloudCmsMetricRuleTemplates(self, "ids",
            ids=["example_value"]
        )
        alicloud.data_alicloud_cms_metric_rule_templates.DataAlicloudCmsMetricRuleTemplates(self, "keyword",
            keyword="^my-MetricRuleTemplate"
        )
        data_alicloud_cms_metric_rule_templates_name_regex =
        alicloud.data_alicloud_cms_metric_rule_templates.DataAlicloudCmsMetricRuleTemplates(self, "nameRegex",
            name_regex="^my-MetricRuleTemplate"
        )
        alicloud.data_alicloud_cms_metric_rule_templates.DataAlicloudCmsMetricRuleTemplates(self, "template_id",
            template_id="example_value"
        )
        cdktf.TerraformOutput(self, "cms_metric_rule_template_id_1",
            value=cdktf.property_access(data_alicloud_cms_metric_rule_templates_ids.templates, ["0", "id"])
        )
        cdktf.TerraformOutput(self, "cms_metric_rule_template_id_2",
            value=cdktf.property_access(data_alicloud_cms_metric_rule_templates_name_regex.templates, ["0", "id"])
        )
        cdktf.TerraformOutput(self, "cms_metric_rule_template_id_3",
            value=cdktf.property_access(data_alicloud_cms_metric_rule_templates_name_regex.templates, ["0", "id"])
        )
        cdktf.TerraformOutput(self, "cms_metric_rule_template_id_4",
            value=cdktf.property_access(data_alicloud_cms_metric_rule_templates_name_regex.templates, ["0", "id"])
        )
```
