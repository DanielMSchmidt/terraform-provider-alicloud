...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_ecd_ad_connector_directories_ids =
        alicloud.data_alicloud_ecd_ad_connector_directories.DataAlicloudEcdAdConnectorDirectories(self, "ids",
            ids=["example_id"]
        )
        cdktf.TerraformOutput(self, "ecd_ad_connector_directory_id_1",
            value=cdktf.property_access(data_alicloud_ecd_ad_connector_directories_ids.directories, ["0", "id"])
        )
```
