...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_mongodb_serverless_instances_example =
        alicloud.data_alicloud_mongodb_serverless_instances.DataAlicloudMongodbServerlessInstances(self, "example",
        ...
        cdktf.TerraformOutput(self, "mongodb_serverless_instance_id_1",
            value=cdktf.property_access(data_alicloud_mongodb_serverless_instances_example.instances, ["0", "id"])
        )
```
