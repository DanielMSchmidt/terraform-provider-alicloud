...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        alicloud.slb.Slb(self, "default",
            name="sample_slb"
        )
        data_alicloud_slbs_slbs_ds =
        alicloud.data_alicloud_slbs.DataAlicloudSlbs(self, "slbs_ds",
            name_regex="sample_slb"
        )
        cdktf.TerraformOutput(self, "first_slb_id",
            value=cdktf.property_access(data_alicloud_slbs_slbs_ds.slbs, ["0", "id"])
        )
```
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        alicloud.data_alicloud_slbs.DataAlicloudSlbs(self, "taggedInstances",
            tags={
                "tag_key1": "tagValue1",
                "tag_key2": "tagValue2"
            }
