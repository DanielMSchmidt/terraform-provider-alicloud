...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_cms_group_metric_rules_example =
        alicloud.data_alicloud_cms_group_metric_rules.DataAlicloudCmsGroupMetricRules(self, "example",
            ids=["4a9a8978-a9cc-55ca-aa7c-530ccd91ae57"],
            name_regex="the_resource_name"
        )
        cdktf.TerraformOutput(self, "first_cms_group_metric_rule_id",
            value=cdktf.property_access(data_alicloud_cms_group_metric_rules_example.rules, ["0", "id"])
        )
```
