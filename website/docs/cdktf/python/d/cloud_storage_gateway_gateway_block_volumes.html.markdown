...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_cloud_storage_gateway_gateway_block_volumes_ids =
        alicloud.data_alicloud_cloud_storage_gateway_gateway_block_volumes.DataAlicloudCloudStorageGatewayGatewayBlockVolumes(self, "ids",
            gateway_id="example_value",
            ids=["example_value-1", "example_value-2"]
        )
        data_alicloud_cloud_storage_gateway_gateway_block_volumes_name_regex =
        alicloud.data_alicloud_cloud_storage_gateway_gateway_block_volumes.DataAlicloudCloudStorageGatewayGatewayBlockVolumes(self, "nameRegex",
            gateway_id="example_value",
            name_regex="^my-GatewayBlockVolume"
        )
        cdktf.TerraformOutput(self, "cloud_storage_gateway_gateway_block_volume_id_1",
            value=cdktf.property_access(data_alicloud_cloud_storage_gateway_gateway_block_volumes_ids.volumes, ["0", "id"])
        )
        cdktf.TerraformOutput(self, "cloud_storage_gateway_gateway_block_volume_id_2",
            value=cdktf.property_access(data_alicloud_cloud_storage_gateway_gateway_block_volumes_name_regex.volumes, ["0", "id"])
        )
```
