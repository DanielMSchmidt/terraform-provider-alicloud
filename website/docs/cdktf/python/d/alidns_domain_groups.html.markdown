...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_alidns_domain_groups_example =
        alicloud.data_alicloud_alidns_domain_groups.DataAlicloudAlidnsDomainGroups(self, "example",
            ids=["c5ef2bc43064445787adf182af2****"]
        )
        cdktf.TerraformOutput(self, "first_domain_group_id",
            value=cdktf.property_access(data_alicloud_alidns_domain_groups_example.groups, ["0", "id"])
        )
```
