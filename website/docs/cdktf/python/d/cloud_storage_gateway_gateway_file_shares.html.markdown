...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_cloud_storage_gateway_gateway_file_shares_ids =
        alicloud.data_alicloud_cloud_storage_gateway_gateway_file_shares.DataAlicloudCloudStorageGatewayGatewayFileShares(self, "ids",
            gateway_id="example_value",
            ids=["example_value-1", "example_value-2"]
        )
        data_alicloud_cloud_storage_gateway_gateway_file_shares_name_regex =
        alicloud.data_alicloud_cloud_storage_gateway_gateway_file_shares.DataAlicloudCloudStorageGatewayGatewayFileShares(self, "nameRegex",
            gateway_id="example_value",
            name_regex="^my-GatewayFileShare"
        )
        cdktf.TerraformOutput(self, "cloud_storage_gateway_gateway_file_share_id_1",
            value=cdktf.property_access(data_alicloud_cloud_storage_gateway_gateway_file_shares_ids.shares, ["0", "id"])
        )
        cdktf.TerraformOutput(self, "cloud_storage_gateway_gateway_file_share_id_2",
            value=cdktf.property_access(data_alicloud_cloud_storage_gateway_gateway_file_shares_name_regex.shares, ["0", "id"])
        )
```
