...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_alb_health_check_templates_ids =
        alicloud.data_alicloud_alb_health_check_templates.DataAlicloudAlbHealthCheckTemplates(self, "ids",
            ids=["example_id"]
        )
        data_alicloud_alb_health_check_templates_name_regex =
        alicloud.data_alicloud_alb_health_check_templates.DataAlicloudAlbHealthCheckTemplates(self, "nameRegex",
            name_regex="^my-HealthCheckTemplate"
        )
        cdktf.TerraformOutput(self, "alb_health_check_template_id_1",
            value=cdktf.property_access(data_alicloud_alb_health_check_templates_ids.templates, ["0", "id"])
        )
        cdktf.TerraformOutput(self, "alb_health_check_template_id_2",
            value=cdktf.property_access(data_alicloud_alb_health_check_templates_name_regex.templates, ["0", "id"])
        )
```
