...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_eci_virtual_nodes_ids =
        alicloud.data_alicloud_eci_virtual_nodes.DataAlicloudEciVirtualNodes(self, "ids",
            ids=["example_value-1", "example_value-2"]
        )
        data_alicloud_eci_virtual_nodes_name_regex =
        alicloud.data_alicloud_eci_virtual_nodes.DataAlicloudEciVirtualNodes(self, "nameRegex",
            name_regex="^my-VirtualNode"
        )
        cdktf.TerraformOutput(self, "eci_virtual_node_id_1",
            value=cdktf.property_access(data_alicloud_eci_virtual_nodes_ids.nodes, ["0", "id"
            ])
        )
        cdktf.TerraformOutput(self, "eci_virtual_node_id_2",
            value=cdktf.property_access(data_alicloud_eci_virtual_nodes_name_regex.nodes, ["0", "id"
            ])
        )
```
