...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_cen_transit_router_multicast_domain_associations_ids =
        alicloud.data_alicloud_cen_transit_router_multicast_domain_associations.DataAlicloudCenTransitRouterMulticastDomainAssociations(self, "ids",
            ids=["example_id"],
        ...
        cdktf.TerraformOutput(self, "cen_transit_router_multicast_domain_id_0",
            value=cdktf.property_access(data_alicloud_cen_transit_router_multicast_domain_associations_ids.associations, ["0", "id"])
        )
```
