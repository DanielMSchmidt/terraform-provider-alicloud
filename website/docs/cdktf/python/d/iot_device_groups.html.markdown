...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_iot_device_groups_ids =
        alicloud.data_alicloud_iot_device_groups.DataAlicloudIotDeviceGroups(self, "ids")
        cdktf.TerraformOutput(self, "iot_device_group_id_1",
            value=cdktf.property_access(data_alicloud_iot_device_groups_ids.groups, ["0", "id"
            ])
        )
```
