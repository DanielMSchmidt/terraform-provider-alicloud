...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_oos_templates_example =
        alicloud.data_alicloud_oos_templates.DataAlicloudOosTemplates(self, "example",
            has_trigger=False,
            name_regex="test",
            share_type="Private",
            tags={
        ...
        cdktf.TerraformOutput(self, "first_template_name",
            value=cdktf.property_access(data_alicloud_oos_templates_example.templates, ["0", "template_name"
            ])
        )
```
