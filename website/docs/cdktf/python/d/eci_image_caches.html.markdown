...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_eci_image_caches_example =
        alicloud.data_alicloud_eci_image_caches.DataAlicloudEciImageCaches(self, "example",
            ids=["imc-bp1ef0dyp7ldhb1d****"]
        )
        cdktf.TerraformOutput(self, "image_cache",
            value=cdktf.property_access(data_alicloud_eci_image_caches_example.caches, ["0", "id"
            ])
        )
```
