...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_alicloud_service_mesh_service_meshes_ids =
        alicloud.data_alicloud_service_mesh_service_meshes.DataAlicloudServiceMeshServiceMeshes(self, "ids",
            ids=["example_id"]
        )
        data_alicloud_service_mesh_service_meshes_name_regex =
        alicloud.data_alicloud_service_mesh_service_meshes.DataAlicloudServiceMeshServiceMeshes(self, "nameRegex",
            name_regex="^my-ServiceMesh"
        )
        data_alicloud_service_mesh_service_meshes_status =
        alicloud.data_alicloud_service_mesh_service_meshes.DataAlicloudServiceMeshServiceMeshes(self, "status",
            ids=["example_id"],
            status="running"
        )
        cdktf.TerraformOutput(self, "service_mesh_service_mesh_id_1",
            value=cdktf.property_access(data_alicloud_service_mesh_service_meshes_ids.meshes, ["0", "id"])
        )
        cdktf.TerraformOutput(self, "service_mesh_service_mesh_id_2",
            value=cdktf.property_access(data_alicloud_service_mesh_service_meshes_name_regex.meshes, ["0", "id"])
        )
        cdktf.TerraformOutput(self, "service_mesh_service_mesh_id_3",
            value=cdktf.property_access(data_alicloud_service_mesh_service_meshes_status.meshes, ["0", "id"])
        )
```
